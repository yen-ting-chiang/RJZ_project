...
allele_frequency_exonic_nonsynonymous_2$sample_name <- 
  factor(allele_frequency_exonic_nonsynonymous_2$sample_name, 
         levels = c("tumor_OB", "tumor_2", "tumor_4", "tumor_5"))
levels(allele_frequency_exonic_nonsynonymous_2$sample_name)
